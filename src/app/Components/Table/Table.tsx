...
const Tabela = () => {
  const dados = [
    { id: 1, nome: 'Beatriz Valezio', status: 'Aberto', servico: 'Cabelo', data:"14/02/2025 - 08:10", valor:"R$50,00" },
    { id: 2, nome: 'Beatriz Valezio', status: 'Aberto', servico: 'Unha', data:"14/02/2025 - 08:10", valor:"R$50,00" },
    { id: 3, nome: 'Beatriz Valezio', status: 'Aberto', servico: 'Maquiagem', data:"14/02/2025 - 08:10", valor:"R$50,00" },
  ];
